<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="Tank_Lab_report.aspx.cs" Inherits="Powder_MISProduct.ReportUI.Tank_Lab_report" %>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="overflow: scroll">
                       <asp:GridView runat="server" ID="gvTankLabReport" CssClass="table table-hover table-striped scrollable" style="text-align:center" AutoGenerateColumns ="True" GridLines="Both" OnRowCreated="gvTankLabReport_RowCreated">
                           <Columns>
