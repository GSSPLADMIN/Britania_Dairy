            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="overflow: scroll">
                        <asp:GridView ID="gvCIPReport" runat="server" GridLines="Both" AutoGenerateColumns="true" HeaderStyle-Wrap="false" Width="100%" ShowHeader="false" OnRowCreated="gvCIPReport_RowCreated" HeaderStyle-Font-Size="Medium" CssClass="table table-striped" 
