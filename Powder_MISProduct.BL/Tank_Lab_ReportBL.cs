...
{
    public class Tank_Lab_ReportBL
    {
        ...
        #region Tank Lab Report 
        public ApplicationResult TankLabReport(DateTime FromDatetime, DateTime ToDatetime)
        {
            try
            {
                ...
                strStoredProcName = "rpt_Tank_Lab_Repot";
